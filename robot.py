...
class Pepper:
    ...
    **Real robot controller**
    ...
    def __init__(self, ip_address, port=9559):
        ...
        self.touch_proxy = self.session.service("ALTouch")
    ...
    def pick_a_volunteer(self, detect_face_props = True):
        """
        ...
        self.unsubscribe_effector()
        self.stand()
        self.say("Looking for volunteers.")
        ...
        if not detect_face_props:
            self.face_detection_service.unsubscribe(proxy_name)
            print('No need to detect face features')
            return
    ...
    def get_robot_name(self, sayOutLoud = False):
        """
